...
class Sidekick:
    ...
    With this feedback, please continue the assignment, ensuring that you meet the success criteria or have a question for the user."""
        ...
        if self.worker_llm_with_tools is not None:
            response = self.worker_llm_with_tools.invoke(messages)
        else:
            raise ValueError("Worker llm with tools is not initialized.")
    ...
    """
        ...
        if self.evaluator_llm_with_output is not None:
            eval_result  = self.evaluator_llm_with_output.invoke(evaluator_messages)
        else:
            raise ValueError("The evaluator_llm was not initialized correctly.")
